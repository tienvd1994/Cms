...
using MyWeb.Core;
using ImageResizer;
using MyWeb.Data.Domain.Media;
using System.Web.Hosting;
using System.Drawing;
using MyWeb.Services.Seo;

namespace MyWeb.Services.Media
{
    public class PictureService : IPictureService
    {
        ...
        protected virtual void DeletePictureThumbs(Picture picture)
        {
            ...
            var thumbDirectoryPath = MapPath("~/content/images/thumbs");
        ...
        {
            var thumbsDirectoryPath = MapPath("~/content/images/thumbs");
        ...
        {
            return Path.Combine(MapPath("~/content/images/"), fileName);
        }
        ...
        {
            string defaultImageFileName = string.Empty;
            ...
            if (targetSize == 0)
            {
                ...
                string url = storeLocation + "content/images/" + defaultImageFileName;
                return url;
            }
            else
            {
